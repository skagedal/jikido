...
android {
    namespace = "tech.skagedal.jikido"
    compileSdk = flutter.compileSdkVersion
    ndkVersion = flutter.ndkVersion

    compileOptions {
        // flutter_local_notifications schedules through java.time, which
        // needs desugaring to work on older Android versions.
    ...
    defaultConfig {
        applicationId = "tech.skagedal.jikido"
